    ...
    >
      <template #top>
        <div class="column q-gap-y-lg full-width">
          <ActionsDefault
            v-model="rows"
            :show-create="auth.hasPermission('due-days_create')"
            :show-view="auth.hasPermission('due-days_view')"
            :show-edit="auth.hasPermission('due-days_edit')"
            :show-destroy="auth.hasPermission('due-days_delete')"
            :items="selected"
