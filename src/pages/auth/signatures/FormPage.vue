<template>
  <div class="row q-gap-sm">
    ...
    <q-toggle v-model="form.hasDiscount"
      left-label
      label="Tem desconto?"
      checked-icon="check"
      color="green"
    ...
    <div class="col-12 row q-gap-x-md q-gap-y-sm">
      <q-select v-model="form.recurrence"
        class="col-md-grow col-xs-12"
      ...
      <q-input v-model="form.discounted_price"
        v-if="form.hasDiscount"
        class="col-md-grow col-xs-12"
      ...
      <q-input v-model="form.total_price"
        class="col-md-grow col-xs-12"
        label="Preço Total"
        readonly
        outlined
    ...
    <div class="col-12 row q-gap-x-md q-gap-y-sm">
      <q-select class="col-md-grow col-xs-12"
